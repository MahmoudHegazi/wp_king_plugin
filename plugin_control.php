...
<div class="postcontent nobottommargin clearfix">
  ...
  <p id="final_result" style="background:lightblue;font-size:1.2em;padding:30px;width:300px;display:none;">
    (Action Started) When Every Thing Completed This Message Will Apear Again  (Action Completed)</p>
